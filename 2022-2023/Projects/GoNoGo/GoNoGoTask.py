...
#NUMPY ARRAY(1) --> PANDAS DATAFRAME(2) --> LIST(3) --> TRIALHANDLER(4)
...
for ExpPhase in range(len(ExpPhases)):
    if ExpPhases[int(ExpPhase)] == 'practice':
        trials = data.TrialHandler(TrialList[3:8], nReps = 1, method = 'random') #Without 'random' you have the exact same sequence of trials in the practice as in the main experiment. I just took 5 trials fromthe TrialList for the practice
