...
# create a dialog box
info = {"What is your name?": "", "What is your participant number?": str(0), "What is the session number?": str(0)}
...
while already_exists:
    ...
    subject_directory  = directory_to_write + "/nr_" + number
    ...
    file_name = subject_directory + "/subject_nr_" + number + "_session_" + session + "_data.txt"
    print(file_name)
