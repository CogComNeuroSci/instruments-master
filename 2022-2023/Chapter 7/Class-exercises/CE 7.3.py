...
goodbye         = visual.TextStim(win,text=(    "This is the end of the experiment.\n\n"+
                                    ...
                                    wrapWidth = win_width*text_width)
pauseMessage    = visual.TextStim(win,text="Pause \n\n"+"Push a button when you are ready to proceed.",
                                    wrapWidth = win_width*text_width)
...
for block in range(2):
    ...
    # create the trials for this loop
    ...
    # present the pause message and measure the pause time
    if block == 0:
        ...
        trials.addData("PauseTime", my_clock.getTime())
