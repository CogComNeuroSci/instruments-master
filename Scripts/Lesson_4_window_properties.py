...
## Of course we start off with importing the visual module and the time module, as explained in the course text of Lesson 4
...
## Also, do not forget to uncomment the ## before the 'fullscr = True' code, then you will see that the window fills your entire screen
    ## Note that you have to delete the ## of only one line of code, if you would delete all the ##, then the first three windows would open and close rapidly
...
## Here, we provide a short overview of all units:
    ...
    ## norm: normalised: stimulus scaled to screen:
