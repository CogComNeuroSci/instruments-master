...
if name == "Daenerys Targaryen":
    print(f"Welcome, {name}, Mother of Dragons")
if name != "Daenerys Targaryen":
    print(f"'{name}', This name is unknown to me")
...
if (FirstName == "Arya") and (LastName == "Stark"):
    print(f"Nymeria is in the castle, {FirstName} {LastName}")
else:
    print(f"Something's off, Nymeria does not belong to {FirstName} {LastName}!")
