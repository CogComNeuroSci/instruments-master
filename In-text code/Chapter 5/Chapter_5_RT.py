...
for trial in range(3):
    ...
    print(f"Your RT is not {round(RT1,1)} ms, nor {round(RT2,1)} ms; it's {round(RT3,1)} ms")
    print(f"The measurement error is either {round(RT1-RT3,1)} ms, or {round(RT2-RT3,1)} ms")
