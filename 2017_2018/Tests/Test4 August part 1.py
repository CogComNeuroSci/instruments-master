...
Basic version; everyone has the same (congruent) mapping
"""
...
instruct        = visual.TextStim(win,text=(    "Push left (letter 'f') for a left arrow\n"+
                                                "Push right (letter 'j') for a right arrow\n\n"+
