...
with open("RandomisationFile_PP_%02d.txt" %SubjectNr, 'r') as f:
...
trialdata = pd.DataFrame(trial, columns = ['Product', 'Price'])

print ('####')
print (trialdata)
print ('####')

trialdata.to_csv("ProductPrice_Order_PP_%02d.txt" %SubjectNr, sep = '\t')
