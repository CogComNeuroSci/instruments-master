...
## Esther: you are not using this anymore, tight?
...
# deduce the correct response
    ...
    ## Esther: indeed, very good optimization of your code!

## Esther: you can still optimize the code a bit more by moving the redundant four lines out of the if-statement
## Esther: the copy = True option is just as good!
if student_nr%2 == 0:
...
## Esther: again, a few of these lines can be taken out of the if-statement
if (student_nr % 2) ==0:
    Instructions.draw()
else:
...
## Esther: I'm happy you found a way of avoiding the duplicated code by removing the if-statement!
#if (student_nr % 2) == 0:

## Esther: number is maybe a bit confusing, how about block?
for number in range(2):
    ...
    ## Esther: I notive that you don't use the trial matrix anymore, that is not necessary but seems a bit unexpected
    for i in range(len(ColorWord)):
        ...
        ## Esther: the .flip and .sleep can be moved outside of the if-statement
        ## Esther: I would also consider using one text stimulus for the feedback and simply update the text, but that's a personal preference
