...
#ver4dubbeld
## Esther: I've moved this here to increase transparancy
bitcoin1= 1
waardes1= [1]
punten1= []
...
## Esther: this is a nice idea: get the increasing bitcoin value out of the way at the start of the script in a simple while-loop
...
## Esther: here you are using the fact that you already know the entire growth curve to optimize the presentation
## Esther: that's a great advantage of your step-wise approach
xstep=1.6/ count
colorstep=2/count
...
## Esther: making all the values for the display is also a great idea, this makes it much easier to debug!
...
for waarde in range(count):
    ...
    punten3.append((x,y3))
    punten4.append((x,y4))
    ## Esther: you clearly found a way to get the colors to transition!
    col=colorstep*(-waarde) + 1 #wit is 1 dus bij waarde = nul zal col 1 zijn
    lijstcolor.append(col)

## Esther: this is indeed the double loop-structure necessary to plot the curve we intended
