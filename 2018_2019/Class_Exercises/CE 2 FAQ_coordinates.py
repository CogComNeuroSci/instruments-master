...
stimulus = visual.Rect(win, width = 0.5, height = 0.5, units = "height", color = "blue")
stimulus.draw()
## 0.5 of the height of the screen means 250 pixels wide and heigh, so we get a square of 250*250 pixels
stimulus = visual.Rect(win, width = 0.5, height = 0.5, units = "norm", color = "red")
stimulus.draw()
...
stimulus = visual.Rect(win, width = 0.5, height = 0.5, units = "deg", color = "yellow")
stimulus.draw()
...
stimulus = visual.Rect(win, size = 0.5, units = "height", color = "blue")
stimulus.draw()
stimulus = visual.Rect(win, size = 0.5, units = "norm", color = "red")
stimulus.draw()
stimulus = visual.Rect(win, size = 0.5, units = "deg", color = "yellow")
stimulus.draw()
