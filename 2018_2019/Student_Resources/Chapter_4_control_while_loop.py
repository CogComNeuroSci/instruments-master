...
## The statement 'i = i+1' is exactly the same as 'i += 1' as we saw in Chapter 3
...
## In the output, we would see nothing, except the title '# While-loop 3.1 #'
