...
### Esther: het is al goed dat je hier een loop heb voor vier keer twee stimuli,
### Esther: maar tracht voor de volgende keer toch echt wel de blok en trial loops onder de knie te krijgen, dat is essentieel
...
for i in range(4):   #we'll use a loop so that we don't have to copy-paste this 4 times
    ...
    win.flip()
    # clear the keyboard input
    ### Esther: hieronder heb je ook een typo
