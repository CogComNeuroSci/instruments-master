...
for block in range(nblocks): 
    ...
    for trial in range(block*ntrials,(block+1)*ntrials):
        ...
        ### Esther: dit is het moment om de klok voor de RT te resetten
        ...
        ### Esther: pas op, je schrijft de accuraatheid al weg zonder de correcte response bepaald te hebben
    ...
    ### Esther: hier dien je ook nog uit de blokloop te breken
