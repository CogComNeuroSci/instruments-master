...
trials = numpy.column_stack([ori_Gauss, sf_Gauss, Key, Accuracy, CorResp])
...
def feedback_message():
    ### Esther: deze hoef je niet op elke trial opnieuw aan te maken
...
for b in range (nblocks): 
    ...
    for i in range(b*ntrials,(b+1)*ntrials):
        ...
        ### Esther: dit is het moment om het keyboard te resetten
        ...
        ### Esther: het is beter om hier al uit de trial loop te breaken zodat de RT niet geregistreerd wordt
