...
def determineCorResp():
    ### Esther: hier kan je zien dat je orientatie op 0 staat
    print(Gabor.ori)
    if Gabor.ori == 30:
        CorResp = "j"
    if Gabor.ori == -30:
...
for block in range (nblocks):
    ...
    for trial in range(ntrials):
        ...
        ### Esther: het is beter om hier geen if-structuur te gebruiken, maar de duratie op voorhand te bepalen
        ...
        ### Esther: dit is niet het moment om de response te registreren
        # define keys
        ...
        ### Esther: omdat je hier je orientatie reset naar 0 werkt de corresp berekening niet
        # reset orientation
        Gabor.ori = 0
        ...
        ### Esther: dit is wel het moment om de response te registreren
