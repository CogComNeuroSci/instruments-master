...
### Esther: deze aanbiedingstijdens zijn 10 keer te klein
...
for b in range(nblocks):
    ...
    ### Esther: pas op, doordat de indexen dezelfde zijn in elke trial loop worden de antwoorden overschreven
    for i in range(ntrials):
        ...
        ### Esther: dit is het moment om de aanbiedingstijd te verifieren
        
        ### Esther: dit is niet het ideale moment om de klok te resetten
