...
for b in range(nblocks):
    ...
    for trials in range(ntrials):
        ...
        ### Esther: deze mag buiten de trial- en block-loop staan want nu maak je de functie aan de start van elke trial opnieuw aan
        ...
        ### Esther: hier kan je best nog eens de responses clearen
        ...
        gaborverticaal.draw()
        win.flip()
        ### ESther: dit is een beter moment om de stimulus presentatietijd te checken
    ...
    ### Esther: hier moet je ook nog eens uit de block loop breken om aan het experiment te kunnen ontsnappen
        
        

### Esther: je kon dit ook gewoon na de block-loop plaatsen in de plaats van via een if-statement te werken
