...
### Esther: het wegschrijven van de spatie en het verifiëren van de spatie is overbodig
...
"Druk op de spatiebalk om verder te gaan.")
    ...
    # aanbieding verticale afleidingsstimuli, trialstimuli en stimuli voor geven antwoord
                ...
                ### Esther: het is niet de bedoeling om de klok op elke trial opnieuw aan te maken
                    trialClock = core.Clock()
    
    ## blijven tekenen gedurende 1 seconde
    ### Esther: dit is niet wat we op het oog hadden
                ...
                ### Esther: met deze klok overschrijf je je andere klok
                    trialClock = core.Clock()
    ...
    ##duur b verwijst terug naar de tijdsduur voor de stimulus uit elks blok b
            ...
            # Esther: hier wil je al breaken zodat je de RT niet registreert
            ...
            ##verder gaan als antwoord gegeven
                    if keys [0] == 'f' or keys[0] == 'j':
                        feedback_message()
                        ### Esther: deze continue is niet nodig
                        continue
