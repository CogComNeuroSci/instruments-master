...
### Esther: pas op, schrijf de naam van de proefpersoon nooit weg naar de trial matrix!
...
def perform_trial(HuidigeAanbTijd):
    ...
    ### Esther: dit is zelfs nog een beter moment om het keyboard te resetten
    ...
    ### Esther: dit is een beter moment om de aanbiedingstijd te meten
    
    ### Esther: dit is niet het beste moment om de RT clock te resetten
    # reset de klok
    my_clockRT.reset()
...
for b in range(nBlok):
    ...
    for i in range(b*nTrial,(b+1)*nTrial):
        ...
        ### Esther: dit is een beter moment om uit de trial loop te breken omdat je dan vermijdt de RTs te registreren
