...
### Esther: dit is volledig overbodig ;)
...
for b in range(nblocks):
    ...
    for t in range(ntrials):
        ...
        gabor.draw()
        ### Esther: dit is het beste moment om het keyboard te clearen
        win.flip()
        ### Esther: dit is het beste moment om de klok te resetten
        core.wait(time)
    ...
    ### Esther: hier dien je ook nog uit de blokloop de breaken

    ## Esther: waarom hier flippen?
    win.flip()
