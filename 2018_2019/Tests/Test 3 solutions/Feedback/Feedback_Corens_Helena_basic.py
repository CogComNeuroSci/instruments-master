...
for i in range(blocks):
    ...
    for x in range(ntrails):
        ...
        ### Esther: het is niet nodig om stimuli aan te maken in de loop, 1 keer voor de loops beginnen volstaat
        ## trials 
        ...
        ### ESther: hier moet je de core.wait() zetten
        
        ### Esther: en hier moet je dan de tweede mask tonen
    ...
    ### Esther: hier moet je ook nog uit de blokloop ontsnappen
