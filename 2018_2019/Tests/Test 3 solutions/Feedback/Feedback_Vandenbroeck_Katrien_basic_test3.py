...
#Make a dialog box
### Esther: het is nog beter om numerische waarden te initialiseren als een numerische waarde
### Esther: bij handvoorkeur ontbreekt ook nog een optie
...
for block in range (n_blocks):
    ...
    for i in range(n_trials):
        ...
        ### Esther: de implementatie van de korte aanbiedingstijd is niet correct, maar wat veel om hier uit te leggen
        clock.reset()
    ...
    ### Esther: hier dien je ook nog eens te ontsnappen aan de blokloop
