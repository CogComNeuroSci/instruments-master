...
### Esther: pas op! Deze aanbiedingstijden zijn 10 keer te groot!
...
## PARTICIPANT INFO
### Esther: vergeet niet de info over de links- of rechtshandigheid van de proefpersoon
...
### Esther: dit zal waarschijnlijk niet lukken gezien Presentation, Orientation, Frecuency, CorResp meer elementen bevat dan Congruency, RT, Resp, Number, Gender, Age
...
### Esther: Presentation, Orientation, Frecuency, CorResp zijn al voorzien op drie blokken, dus je hebt geen drie repeats meer nodig
...
def perform_trial():
    ...
    ### Esther: dit is een beter moment om het keayboard te clearen
    ...
    ### Esther: hier moet je dan wachten voor 16, 33 of 50 ms
...
def congruency_function(Orientation = 30, CorResp = "j"):
    ### Esther: hier maak je fouten tegen = versus == in de logische vergelijking
...
for b in range(nblock):
    ...
    ### Esther: het is niet nodig om de instructies te herhalen aan de start van elk blok
    ...
    ### Esther: hier moet je ook nog eens uit het blok breken
