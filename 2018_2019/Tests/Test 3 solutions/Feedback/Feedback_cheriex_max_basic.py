...
### Esther: niet exact de dimensies die we gevraagd hadden, let ook op de details!
...
### Esther: heel goed, volgende keer kan je ook de stimulus properties nog mee opslaan in de trial matrix
### ESther: dat zou je ook geholpen hebben om in het tweede blok nog je orientatie en sf op te halen voor de Gabor
...
verticalGabor = visual.GratingStim(win, tex="sin", mask="gauss", texRes=256, size=[1, 1], sf=0, ori =(0))   ### Esther: extra haakjes voor de fun?
