...
#blockloop
### Esther: het is beter om deze string aan te passen aan de index van de block loop, zodat de code schaalbaar is naar een volledig experiment
...
for b in range (3):
    ...
    for i in range (8):
        ...
        gabor.draw()
        ### Esther: hieronder heb je ook een syntaxfout
        event.clearEvents(eventType="keyboard",)
        win.waitBlanking
        win.flip()
        Clock.reset()
        
        ### Esther: dit is nog niet het moment om de response te registreren
    ...
    ### Esther: hier zal je ook nog eens uit de blok loop moeten breken
