...
### Esther: pas op, niet exact de afmetingen die we gevraagd hadden
...
for block in range(nblocks):
    ...
    ### Esther: hier was het de bedoeling dat je block (de index van de blok loop) zou gebruiken in de aankondiging van het nieuwe blok
    
    text(messagetext = "Een nieuw blok begint. \n\nDruk op de spatiebalk om verder te gaan", response_key = "space", duration = 0)
    
    ### Esther: pas op, gezien de indexen dezelfde zijn tijdens elke trial loop, zal je de antwoorden overschrijven
    for trial in range(ntrials):
        ...
        ### Esther: dit is het moment om de klok te resetten voor de RT meting
    ...
    ### Esther: hier escape je best ook nog eens uit de blok loop
