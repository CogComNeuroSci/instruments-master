...
info = {"Participant number":0, "Age":0, "Gender":["male", "female", "third gender"], "Handedness":["right", "left", "ambidextrous"]}

name = {"Participant name":"Incognito"}
...
while already_exists:
    ...
    file_name = directory_to_write_to + "/Test4_subject_" + str(info["Participant number"]) + "_Anonymity2"
