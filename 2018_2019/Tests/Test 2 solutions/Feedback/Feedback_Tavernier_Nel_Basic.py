...
## Esther: dit laatste klopt niet, je moet sun.radius * 1.03 doen ;)
...
# Graphical elements
## Esther: let op, puur geel is [1, 1, -1] gezien de rgb schaal van -1 tot 1 loopt
...
## Esther: inderdaad, omdat de update niet goed zat
...
#    print(red_making)
    ...
    ## Esther: bahalve het feit dat je blauw hier beter op -1 had staan, is dit wel de goede denkwijze
...
#    time.sleep(0.1)
#    
## Esther: deze vergelijking zal niet lukken voor het detecteren van een botsing
