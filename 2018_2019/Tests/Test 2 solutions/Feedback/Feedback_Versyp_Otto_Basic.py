...
## Esther: let op, deze while loop was eigenlijk niet nodig, uit de for-loop breken was voldoende ;)
...
## Esther: let op, je hebt niet gedacht aan het scenario waarbij geen van de hemellichamen botst!
