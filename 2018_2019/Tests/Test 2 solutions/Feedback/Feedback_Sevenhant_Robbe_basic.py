...
for groei in range(60):
    ...
    ## Esther: het is nog beter om de stimuli aan te maken voor de loop en hier dan enkel de kleur, radius en positie aan te passen
    ## Esther: let er op dat de rgb waarden van -1 tot 1 lopen! Blauw mocht dus op -1 staan
    ...
    ## Esther: inderdaad, Moonreal bestaat niet
