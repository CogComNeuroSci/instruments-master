...
## Esther: dit moest geïmplementeerd worden via het rgb systeem, niet via labels
...
for i in sizes:
    ## Esther: het is nog beter om de stimulus aan te maken voor de loop en hier dan de kleur, radius en positie aan te passen
