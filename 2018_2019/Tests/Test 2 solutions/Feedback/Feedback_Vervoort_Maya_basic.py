...
Crash = False
## Esther: deze while-loop komt waarschijnlijk van test 2 en heeft je op het verkeerde been gezet, de for-loop volstond
while Crash == False and time <= time_end:
    for i in range(len(earthx)):
            ...
            ## Esther: het is nog beter om deze stimuli aan te maken voor de loop en hier dan de kleur, posities en radius te updaten
