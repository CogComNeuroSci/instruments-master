...
#tekst botsing
## Esther: het is een nog beter idee om 1 text stimulus te maken en hier dan de text van te wijzigen
...
## Esther: eigenlijk is deze for-loop vervangen door de while-loop met a counter hieronder
for i in range(60):
    a= 0
    ...
    while radAZ <= afstAZ and radMZ <= afstMZ and rad_zon < 1:
        ...
        #Coordinaten maan 
        ## Esther: hieronder is er iets misgegaan met de coordinaten (y in plaats van x gebruikt)
        ...
        ## Esther: het is nog beter om de grafische elementen aan te maken voor de loop en hier dan enkel de kleur, positie en radius aan te passen, indien nodig
