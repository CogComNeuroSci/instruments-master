...
#make a window
## Esther: pas op, we hadden gevraagd voor het genormaliseerd coordinatensysteem, niet pixels!
...
for i in range (60):
    ...
    ##change size of Sun
    ## Esther: we hadden wel voor 103% gevraagd in plaats van 102%, maar ik zie het door de vingers 
    ## Esther: (bij nader inzien is het misschien een truck om het niet te doen opvallen dat je loop niet automatisch stopt bij een botsing ;p)
    Sun.radius=(Radius_sun+0.09*Radius_sun)
    Radius_sun=Radius_sun+0.09*Radius_sun
    ...
    ## ESther: pas op, nu ga je niet uit de loop na een botsing!
    ##If statements
