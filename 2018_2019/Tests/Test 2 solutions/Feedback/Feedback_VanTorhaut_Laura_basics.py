...
## Esther: geel is eigenlijk 1 1 -1
...
## Esther: hier moest de radius van de maan niet maal twee!
...
while radius1 < 1: ## als de radius groter is dan 1, dan past de zon niet meer op het scherm en stopt de loop
    ## Esther: dit is niet de aangroei die we gevraagd hebben!
    ...
    if zon2.overlaps(maan):
        ...
        text1.draw ()
        ## Esther: je mist hier telkens flip statements!
        time.sleep (1)
    if zon2.overlaps(planeet):
        text2 = visual.TextStim (win, text = "De planeet heeft de rode reus geraakt")
        text2.draw ()
        time.sleep (1)
    ## Esther: pas op, nu kunnen er verschillende boodschappen verschijnen, dat is niet de bedoeling
