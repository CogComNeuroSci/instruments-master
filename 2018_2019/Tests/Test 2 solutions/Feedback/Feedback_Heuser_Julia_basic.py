...
win.flip()
time.sleep(1)
## Esther: inderdaad, maar hieronder heb je het wel goed kunnen doen, dus je krijgt het punt toch ;)
...
for i in sizes:
    ## Esther: het is nog beter om de stimuli aan te maken voor de loop start en hier dan gewoon de radius, positie en kleur aan te passen
...
for i in range(60):
        ...
        moon.draw()
        ## Esther: pas op, de win.flip() hoort voor de time.sleep() te komen
        time.sleep(0.05)
        win.flip()
