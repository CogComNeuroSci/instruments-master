...
## Esther: let er op dat de rgb waarden van -1 tot 1 gaan, niet van 0 tot 1
## Esther: hier ontbreken elementen na de laatste komma

## Esther: de radii zijn de helf te klein
...
for i in range(60):
    ## Esther: waarom niet gewoon -0.016 en *1.03? geen reden om het onderstaande te proberen ;)
...
#tekst botsing
## Esther: er wordt geen rekening gehouden met de simultane botsing van planeet en maan met de zon
...
feedback_tekst.draw()
win.flip()
## Esther: time.sleep() ontbreekt vaak!
