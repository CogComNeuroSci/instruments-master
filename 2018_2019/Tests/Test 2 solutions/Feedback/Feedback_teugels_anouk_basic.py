...
for change in range(n_steps):
    ...
    ## Esther: het is nog beter om deze stimuli aan te maken voor de loop en dan enkel hun positie te updaten in de loop
...
if sun.overlaps(planet):
    ...
    ## Esther: pas op, in de if-structuur moet je eerst kijken of aan beide voorwaarden voldaan wordt, anders komt deze feedback nooit op het scherm
