...
## Esther: goede tussenoplossing voor als je vast zit
#groeiende zon
...
## Esther: niet helemaal, blauw mocht meteen op -1 staan en enkel groen moest afnemen van 1 tot -1
...
for i in sizes:
    ## Esther: het is nog beter om enkel de kleur, radius en positie te updaten in de loop in plaats van de stimulus opnieuw aan te maken
