...
for i in range(60):
    ## Esther: deze if-structuur had vermeden kunnen worden
    if i >= 1:
        ...
        ## Esther: de waarde van blauw mag altijd op -1 blijven staan, enkel de waarde voor groen daalt van 1 tot -1
...
#            nieuwekleurzon = [1, -(1- (0.1*i)), 0]
    ...
    #grafische elementen initialiseren
    ## Esther: hier had je heel gemakkelijk de .radius waarde van de zon kunnen aanpassen in plaats van de zon opnieuw te moeten aanmaken
    ...
    ## Esther: zo was het gelukt, maar dan moest je natuurlijk nog de presenatie stoppen bij een botsing
...
## Esther: ik vermoed dat het fout liep toen je de booschap aanmaakte nadat je hem al had proberen wijzigen?
...
## ESther: nu moest je eigenlijk enkel nog de coordinaten aanspreken via de index
