...
## Esther: let op, vermenigvuldigen met twee is niet nodig!
diameterzon=0.15*2
...
## Esther: hier moest je eventueel de diameter van de zon delen door twee, maar niet de vierkantswortel nemen
...
for i in sizeszon:
    ...
    for i in sizeszon:
        ...
        ## Esther: oei, je moest gewoon alle coordinaten 1 voor 1 afgaan, geen random sample nemen!
