...
## Esther: het is nog beter om 1 text stimulus te maken en dan enkel de text te wijzigen
...
## Esther: we missen enkel nog de boodschap dat geen enkele van de hemellichamen de zon heeft geraakt!
...
for rotation in range (len(OrbitMoonx)):
    ...
    moon.draw()
    win.flip()
    ##Esther: liefst even laten wachten zodat het niet te spastisch wordt
    time.sleep(0.1)
