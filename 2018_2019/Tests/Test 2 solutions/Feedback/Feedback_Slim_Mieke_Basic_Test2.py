...
## Other variable: initial radius of the sun and the value of green in the sun's RGB code
sunradius = 0.15
green = 1 
...
for step in range(60):
    ...
    green -= (step/200)             ## The '200' in this line is the result of some tinkering: I just thought the colour transition looked quite smooth this way. 
    if green < -1:                  ## This if-statement is added in order to prevent edge case issues
        green = -1
        ## Esther: that's indeed the icing on the cake!
    sun = visual.Circle(win, units = 'norm', radius = sunradius, color = (1, green, -1))
    ...
    moon.draw()
    win.flip()
    time.sleep(0.1)  ## I've decided to use this duration as I thought it looked smooth enough this way, without being incredibly fast.
