...
while already_exists:
    ...
    # Esther: je moet natuurlijk ook nog de /data/ toevoegen, want anders zal je file niet opgeslagen worden in de data map
    ...
    if not os.path.isfile(file_name):
        ...
        # Esther: liever hier ook communicatie via een dialogue box in plaats van via een window
...
# Esther: het is een goed idee om de tekst op te splitsen over verschillende regels zodat het script beter leesbaar wordt
...
## Esther: wat je hier natuurlijk nog tekort komt is de trial matrix om de data van al je blokken in op te slaan zodat je je trialinfo niet overschrijft
...
## Esther: goed dat je hier met cross tables probeert te werken, maar het is wel een beetje vijgen na Pasen gezien de trials al afgelopen zijn
