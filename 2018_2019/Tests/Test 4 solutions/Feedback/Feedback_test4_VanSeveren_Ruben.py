...
while already_exists:
    ...
    # Esther: je had je proefpersoonnummer al aangemaakt als een string, dus niet nodig om die hier nog eens om te zetten naar een string
    # Esther: de _data op het einde was niet nodig
...
# Esther: dit is inderdaad de goede manier om het factorieel design te schrijven, maar nu moest je het nog inpluggen in de trialHandler

# Esther: pas op, dat zijn niet de correcte coordinaten voor in het norm assenstelsel! Al je stimuli zullen rechts op het scherm staan
