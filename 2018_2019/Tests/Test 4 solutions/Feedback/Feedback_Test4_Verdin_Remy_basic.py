...
# Esther: hm nee, hier wilden we dat je een subfolder data maakt en dat daarin de data file komt, dat lukt niet met de code hieronder

file_name = directory_to_write_to + "Test4_subject_" + str(info["Participant number"])


#design
Design_block = [{"Stimulus": ">", "Position": [-0.5,0], "Congruency": "Incongruent" },\
                 {"Stimulus": ">", "Position": [0,0], "Congruency": "Neutral" }, \
                 {"Stimulus": ">", "Position": [0.5,0], "Congruency": "Congruent" },\
                 {"Stimulus": "<", "Position": [-0.5,0], "Congruency": "Congruent" },\
                 {"Stimulus": "<", "Position": [0,0], "Congruency": "Neutral" },\
                 {"Stimulus": "<", "Position": [0.5,0], "Congruency": "Incongruent" }]
...
# Esther: let op, de info over de naam van je proefpersoon staat hier nog in je gui info, dus die komt ook terecht in je datafile!
...
# Esther: aha oef, je overschrijft hier de ExperimentHandler zodat de naam van de proefpersoon toch niet in de file staat, chance!
...
# Esther: pas op, zorg ervoor dat de proefpersoon altijd weet op welke button ze moeten drukken
