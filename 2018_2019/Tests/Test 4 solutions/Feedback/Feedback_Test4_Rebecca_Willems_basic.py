...
#    # if the folder doesn't exist yet, make it
    ...
    # Esther: let op, je hoeft niet nog eens /data te doen, gewoon /Test4_subject_ etc.
...
Design = [{"Arrow": "<", "Position": -0.5}, {"Arrow": "<", "Position": 0}, {"Arrow": "<", "Position": 0.5}, \
          {"Arrow": ">", "Position": -0.5}, {"Arrow": ">", "Position": 0}, {"Arrow": ">", "Position": 0.5} ]
#
#
#count = 0
...
#    # announce the block start
    ...
    # Esther: je implementatie hierboven met arrays en je implementatie in randomization step 1 waren beiden correct
    # Esther: de code hieronder had je niet nodig
...
#    
    # Esther: fullRandom is nog niet iets beter dan random
#    
...
#        ## wait for the response
        ...
        my_clock.reset()
        keys = event.waitKeys(keyList = ["left","right"])   # Esther: vergeet de optie down niet die bovenaan in je script klaarstond
#        
#        ## register the output
