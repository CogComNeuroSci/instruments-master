...
# Esther: je hoefde de gui hier niet al eens te tonen, want je toont het sowieso opnieuw aan de start van de while loop voor de file naam
...
# Esther: hier moest je nu in de blokloop telkens een trialHandler maken
# Esther: voor je trials loop je dan over de items in de trialHandler
...
# Esther: hier met de clock gereset worden
