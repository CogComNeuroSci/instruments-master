...
## Esther: waarom nblocks+1? Doen we een 13de blokje?

for block in range(nblocks+1):
    
    ## Esther: fullRandom is hier nog beter dan random
    ## Esther: je zal zeker meer dan 1 herhaling nodig hebben om aan 60 trials te geraken
    ...
    for trial in trials:
        ...
        ## Esther: je hoeft de congruentie niet meer expliciet toe te voegen, dat gebeurt automatisch via de trialhandler
