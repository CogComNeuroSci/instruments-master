...
#################################################################################################################################################
#ik had onvoldoende tijd voor de advanced, maar heb toch nog geprobeerd om deze zo goed mogelijk te maken of op te schrijven hoe ik het zou maken
#################################################################################################################################################
# import modules
...
for block in range(nblocks+1):
    ...
    ##advanced niveau vraag 1: --> deze vraag zou ik oplossen analoog aan opgave 8.3
...
# Esther: het is goed dat je de cross tables hier probeert, maar het is een beetje vijgen na pasen gezien het experiment al uitgevoerd is

core.quit()
#validation
trials=pandas.DataFrame.from_dict(trials)

trials.column=["Pijltje","Pos","Response","RT","Congruentie","CorResp","Accuracy","Blocknr"]

print("Block randomization")
print(pandas.crosstab(trials.Pijltje, [trials.Pos, trials.Blocknr]))
print("Block Congruentie")
print(pandas.crosstab(trials.Congruentie, trials.Blocknr))
print("Correct answers")
print(pandas.crosstab([trials.COrResp, trials.Response])
