...
while already_exists:
    ...
    # Esther: hier nog geen .csv aan de file toevoegen! 
...
# Esther: let op: door hier niet de info over de naam van de proefpersoon te verwijderen zit die info meteen opgeslagen in de data file
...
# Esther: het verwijderen van de naam moet komen voor je de ExperimentHandler start
...
# Esther: de twee lijntjes code hieronder moeten in de blokloop komen zodat je de randomisatie op elk blok anders maakt
# Esther: dit zal er ook voor zorgen dat de data worden weggeschreven op trialniveau
# Esther: het is ook nog net iets beter om fullRandom te gebruiken in plaats van random

trials= data.TrialHandler(triallist, nReps= 10, method="random")
thisExp.addLoop(trials)

# Esther: het bepalen van de congruentie moest je eigenlijk voor de trialhandler doen
# ESther: het is ook niet mogelijk om meerdere waarden tegelijk te valideren (pijn == "->")
...
for block in range(12):
    ...
    # Esther: hier is wel handig om de tekst op te splitsen over verschillende lijnen voor de leesbaarheid van het script
    
    # Esther: dit moest <= 8 zijn
    ...
    for trial in  trials:
        ...
        # Esther: hier moest de win.flip() komen!
...
# Esther: het is goed dat je een kruistabel uitprobeert maar het is wat vijgen na pasen als dit pas gebeurt nadat de trials al uitgevoerd zijn
