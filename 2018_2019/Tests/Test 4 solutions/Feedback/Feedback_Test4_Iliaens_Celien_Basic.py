...
DesignDirection = [{"Direction":"<-","Position": posL,"Correct":"left"},{"Direction":"<-","Position": posR,"Correct":"left"},{"Direction":"<-","Position": posM,"Correct":"left"},\
                   {"Direction":"->","Position": posL,"Correct":"right"},{"Direction":"->","Position": posR,"Correct":"right"},{"Direction":"->","Position": posM,"Correct":"right"}]
DesignPosition = [{"Direction":"<-","Position": posL,"Correct":"left"},{"Direction":"<-","Position": posR,"Correct":"right"},{"Direction":"<-","Position": posM,"Correct":"up"},\
                  {"Direction":"->","Position": posL,"Correct":"left"},{"Direction":"->","Position": posR,"Correct":"right"},{"Direction":"->","Position": posM,"Correct":"up"}]

# Esther: je kon hier eigenlijk ook meteen al de congruentie bepaald hebben ;)
...
for block in range(nblocks):
    ...
    for trial in trials:
        ...
        # Esther: de info uit de trialHandler is meteen al opgeslagen in de output, die hoef je dus niet meer te herhalen
