...
Position = numpy.array([1/4, 2/4, 3/4])         # Esther: pas op, hierdoor staan je stimuli allemaal op de rechter helft van het scherm
Stimuli = numpy.append([Direction], [Position])

# Esther: wat je hier van plan was met Stimuli is waarschijnlijk niet gelukt zoals je het wilde
# Esther: daardoor werken ook de volgende lijnen code niet zoals je wil
...
def perform_trial():
    ...
    # Esther: hier ben je een haakje vergeten sluiten en daardoor krijg je op de lijn hierna een error message
...
for b in range(nblocks):
    ...
    # Esther: je bent hieronder code van de trialhandler en de arrays aanpak door elkaar aan het gebruiken
