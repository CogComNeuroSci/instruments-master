...
# Esther: ha, met de aanpak die je hebt gebruikt moet je meteen een extensie aan je file plakken want dat wordt niet automatisch gedaan als bij de ExperimentHandler

# importeer de nodige modules
from psychopy import visual, event, core, gui
import time, numpy, os, pandas

# Esther: we zagen graag dat je deze folder zelf kan aanmaken
...
while already_exists:
    ...
    # Esther: gezien je niet met een ExperimentHandler werkt, moet je meteen de .csv extensie aan je filenaam kleven
...
# Esther: ik snap de logica niet volledig achter de twee lijnen hieronder
...
# Esther: voor de twee functies hieronder: waarom is het nodig om met een if-statement te werken als je toch info overkopieert van de ene variabele naar de andere?
