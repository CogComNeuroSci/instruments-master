...
# Esther: pas op, hier sla je de naam van de proefpersoon mee op in de output file
...
# Esther: aha, ik had het eerst nog niet gezien dat je hier al meteen 60 trials probeert te implementeren, dat zal je trialHandler wel niet vlot kunnen verwerken...
...
for b in range(nblocks):
    ...
    # Esther: hier dus beter werken met nreps = 60 en fullRandom
    ...
    for trial in trials:
        ...
        # Esther: hier natuurlijk ook nog de keys opslaan
