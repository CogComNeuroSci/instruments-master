...
while already_exists:
    ...
    if not os.path.isfile(file_name+".csv"):
        ...
        # Esther: pas op, dit is niet de goede approach want hierna zal de originele dialogue box opnieuw verschijnen
...
# Esther: die instructies had ik liever aan het begin van elk blok gezien, want dit wordt heel moeilijk uit te voeren voor je proefpersoon
...
Design = [{"pijl": ">", "pos":(0.0, 0.0)}, {"pijl": ">", "pos":(0.5, 0.0)}, {"pijl": ">", "pos":(-0.5, 0.0)}, \
          {"pijl": "<", "pos":(0.0, 0.0)}, {"pijl": "<", "pos":(0.5, 0.0)}, {"pijl": "<", "pos":(-0.5, 0.0)}]

# Esther: het design ziet er goed uit, maar voor de leesbaarheid misschien beter opsplitsen in een aantal aparte regels
# Esther: je kon trouwens heel gemakkelijk ook de congruentie hier al toegevoegd hebben aan het design
...
#           event.waitKeys(keyList = "space")
        ...
        # Esther: nice touch to differentiate between the valid response options, that compensates a bit for the finding the right key names ;p
        if (block) >= 7:
