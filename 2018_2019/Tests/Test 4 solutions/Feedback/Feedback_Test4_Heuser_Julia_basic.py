...
while already_exists:
    ...
    # Esther: dit is niet precies de foldernaam die we vroegen
...
for b in range(nblocks):
    ...
    for i in range(b*ntrials,(b+1)*ntrials):
        ...
        PijlLinks.pos   = int(trials[i,4])      # Esther: zo heb je nu enkel een waarde op de horizontale as, maar nog geen waarde voor de vertikale as
        ...
        keys = event.waitKeys(keyList = ["left","right"])       # Esther: the down option should also have been included
