...
# Esther: heel goed gedaan tot hier, originele en correct optie
# Esther: als je het random shufflen ook nog herhaalt in de blokloop is dit een goede piste

# huidige directory bepalen
mijn_directory = os.getcwd ()

# Esther: de lijn hieronder mag weg, maar hindert gelukkig je script niet
...
while already_exists:
    ...
    # Esther: er zijn een aantal dingen mis hier, zo heb je /data niet meer nodig en de file naam is niet helemaal zoals we gevraagd hadden
...
# Esther: zorg er voor dat je proefpersoon ook op het einde nog weet op welke knop te drukken
