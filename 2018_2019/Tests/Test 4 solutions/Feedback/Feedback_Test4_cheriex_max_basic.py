...
while already_exists:
    ...
    ## Esther: pas op, deze manier van de file name te benoemen is gepast voor wanneer je met een ExperimentHandler werkt
    ## Esther: hier heb je nu geen extensie aan je filenaam en die wordt ook niet automatisch toegevoegd door de ExperimentHandler
    ## Esther: de check voor de .csv file zal dus nooit resulteren in de detectie van een reeds bestaande file
...
for blocki in range(nBlocks):
    ...
    ## Esther: de participantinfo hieronder kan je ook buiten de loop opslaan in je trials matrix
 ...
 #   trials[CurrentTrials, 6] = CurrentTrials[blocki]                # store the cumulative trial number
    ...
    ## Esther: pas op, in de logische vergelijking hieronder ben je verschillende dingen tegenlijk aan het vergelijken en dat loopt spaak
...
for b in range(nBlocks):
    ...
    for triali in range(nBlockTrials):
        ...
        ## Esther: hieronder ben je een haakje vergeten waardoor er een syntaxfout ontstaat op de volgende trial
        ...
        ## ESther: registreer misschien liever hier eerst je RT in plaats van eerst nog een paar bewerkingen te doen
...
# Esther: goed dat je hier cross tables probeert, maar het is wel een beete vijgen na pasen om je randomisatie te bekijken nadat je alle trials al hebt moeten uitvoeren.
