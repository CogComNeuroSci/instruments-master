...
while already_exists:
    ...
    # Esther: pas op, hier voeg je eigenlijk een nul in voor je proefpersoonnummer
...
# Esther: je hebt hier waarschijnlijk de fout gemaakt van een string te proberen opslaan in een array waardoor alle waarden strings worden
# Esther: daardoor geraak je de betekenis van je posities ook meteen kwijt (je kan ze neit rechtstreeks gebruiken in de trial loop)
...
# Esther: pas op, dit is niet een 2*3 design ;)
...
# Esther: het is misschien iets handiger om de tekst op te splitsen over verschillende lijnen zodat je code vlotter leesbaar is
...
for block in range (10):
    ...
    # Esther: die positieinfo zal hier niet werken aangezien het is opgeslagen als een string in plaats van een tuple
