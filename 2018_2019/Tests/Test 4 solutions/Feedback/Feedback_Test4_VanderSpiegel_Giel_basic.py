...
while already_exists:
    ...
    # Esther: om de puntjes op de i te zetten: /data was voldoende
    
    directory_to_write_to = my_directory + "/data_test4"
    if not os.path.isdir(directory_to_write_to):
        os.mkdir(directory_to_write_to)
    
    # Esther: niet nodig om "/test4" +"_subject_" op te splitsen in twee aparte stukken
...
# Esther: maybe add an extra space before the name ;)
...
# Esther: hm, dit is niet het factorieel design dat je zoekt
...
# Esther: pas op, tracht dit soort kleine syntax errors uit je code te houden zodat je tenminste kan runnen wat je nu al hebt.
