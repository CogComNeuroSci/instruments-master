...
# Esther: pas op, je moet hier ook nog de naam van de proefpersoon verwijderen uit de output van je dialogue box, anders komt de naam van je proefpersoon in de output file
thisExp = data.ExperimentHandler(dataFileName = file_name, extraInfo = info)

# Esther: algemene opmerking over de text stimuli: het is handiger als je de strings kan opsplitsen over verschillende lijnen zodat het script vlotter leesbaar is
...
# Esther: dit moest dus voor de ExperimentHandler komen of de ExperimentHandler moest hierna komen
info.pop("Naam participant")

# 3-by-2 factorial design

# Esther: je bent hier onderweg een comma vergeten.
# Esther: tip: splits je lijst op over verschillende lijnen zodat het eenvoudiger is je code te inspecteren en debuggen

# Esther: de string aanpak om je coordinaten van de stimululs te bepalen ging niet gelukt zijn
...
# Esther: dit was op zich een mogelijke strategie, maar niet erg flexibel en er moet hiervoor een blokloop zijn die werkt
...
# Esther: hieronder was fullRandom nog beter geweest dan random
...
## Esther: accuratheid speelde geen rol in deze opdracht
...
#    
    # Esther: het is beter om hier meteen de RT te meten in plaats van dit uit te stellen tot later
