...
## Esther: hieronder heb je een syntaxfout gezien je een = teken bent vergeten
...
## Esther: vergeet niet dat de proefpersoon altijd moet weten op welke knop ze moeten drukken om verder te gaan

## randomisatie

## Esther: Hm, waarom de posities ook meteen als string definiëren? Die kon je gerust numerisch houden
...
for blocki in range(nBlocks):
    ...
    for trial in blockTrials:
        ...
        ## ESther: de lijn hieronder verwijderen
        thisExp.nextEntry()
        
        # hier zit ik even vast, andere implementatieprobeersel
        
        ## Esther: deze loop verwijderen
         for trial in blocktrials:
            
             ## Esther: de code hieronder behouden maar een level minder indenteren
            ...
            ## ESther: deze twee lijnen zijn ook overbodig
            if (block == 1) :
                block +=1
