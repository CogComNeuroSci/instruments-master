...
# Esther: in de structuur hieronder los je het probleem van de twee soorten trials op door veel code te herhalen, dit kon net iets eleganter
...
for blocki in range(nBlocks): 
    ...
    if blocki < 8: 
        ...
        for trial in richtingBlockTrials:
            ...
            # Esther: we hadden geen response deadline gevraagd, maar heb er geen punten voor afgetrokken
