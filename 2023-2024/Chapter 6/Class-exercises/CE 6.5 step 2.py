...
# select three practice trials
practice = trials[[3,9,15],]
...
for i in range(practice.shape[0]):
...
# announce that the actual experiment is about to start
message(message_text = "That was the practice round.\n\nPress the space bar to start the actual experiment.", response_key = "space")
...
for b in range(nblocks):
    ...
    for i in range(b*ntrials,(b+1)*ntrials):
        ...
        # determine and display the feedback message
        feedback(correct = int(trials[i,5]))
