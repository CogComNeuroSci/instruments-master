...
for b in range(nblocks):
    ...
    if b == 0:
        ...
        Instructions_text = (   "Carefully read the instructions, they will change across blocks!\n\n" +
    ...
    for i in range(b*nprac,(b+1)*nprac):
        ...
        if b == 0:
            # atypical Stroop instructions in the first block
            practice[i,3] = determine_CorResp(practice[i,0])
        else:
            # typical Stroop instructions in the second block
